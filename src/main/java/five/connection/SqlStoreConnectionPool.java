...
public class SqlStoreConnectionPool implements ConnectionPool {
    private static SqlStoreConnectionPool CONNECTION_POOL_INSTANCE = null;
    ...
    public static ConnectionPool instance() {
        if (CONNECTION_POOL_INSTANCE == null) {
            CONNECTION_POOL_INSTANCE = new SqlStoreConnectionPool();
        }
    ...
    public Connection getConnection() {
        if(connectionPool.isEmpty()){
            System.err.println("No more connection objects in connection pool");
            return null;
        }
